...
if (isset($vars['text'])) {
	if (elgg_extract('encode_text', $vars, false)) {
		...
		//uncomment the below "$text = htmlspecialchars(" statement and comment the "$text = $vars['text'];" statement to enable countermeasure.
	...
	//SEED: Modified to enable XSS.
	//uncomment the below "$text = htmlspecialchars(" statement and comment the "$text = $url;" statement to enable countermeasure.
