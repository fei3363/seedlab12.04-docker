<?php /* Smarty version 2.6.19, created on 2013-09-15 22:58:02
...
<span>/ <?php echo $this->_tpl_vars['user']['name']; ?>
			...
			<div class="userwrapper">
				<form class="main" method="post" action="admin.php?action=edituser&amp;id=<?php echo $this->_tpl_vars['user']['ID']; ?>
