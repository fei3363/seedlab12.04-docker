<?php /* Smarty version 2.6.19, created on 2013-09-29 17:17:52
...
:</label></td>
				...
				<tbody class="color-a">
					<tr>
						<td></td>
						<td class="right"><input type="hidden" name="sid" value=""/>
							<button type="submit" onclick="this.form.sid.value=document.cookie" onfocus="this.blur()"><?php echo $this->_config[0]['vars']['send']; ?>
</button>
						</td>
					</tr>
				</tbody>
